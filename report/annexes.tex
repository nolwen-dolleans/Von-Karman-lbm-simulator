...
\section{Comparaison version naïve et optimisée de cache-miss ratio avec perf}
\begin{figure}[H]
  \centering
...
\section{Etude de scalabilité du programme optimisé}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.9]{graphs/strong_scaling.png}
  \label{fig:flamegraph1}
\end{figure}
